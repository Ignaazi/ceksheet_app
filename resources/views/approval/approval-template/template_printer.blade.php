...
<style>
    /* Layout Utama untuk Tampilan Langsung */
    body {
        background-color: #525659; /* Warna background ala PDF Viewer */
        padding: 20px 0;
    }
...
<!-- BAR TOMBOL AKSI (PRINT & DOWNLOAD) -->
<div class="action-bar">
    <div class="fw-bold">
        <i class="fa-solid fa-file-invoice text-warning me-2"></i> Approval Sheet
    </div>
...
<!-- SCRIPT PENGATURAN DOWNLOAD PDF -->
<script>
