<aside class="sidebar flex-shrink-0">
  <ul class="sidebar-nav d-flex flex-column gap-1 list-unstyled px-2">
    ...
    <!-- SECTION: MAIN MENU (Dashboard Selalu Tampil) -->
    <li class="nav-item">
    ...
    <!-- Cek apakah user punya setidaknya salah satu akses di System Management -->
    @canany(['view-users', 'view-permissions', 'view-ip_config'])
    ...
    <!-- USER ACCOUNTS MENU (Hanya muncul jika punya permission view-users) -->
    @can('view-users')
      <li class="nav-item">
    ...
    <!-- DROPDOWN SYSTEM SETTINGS (Hanya muncul jika punya akses ke permissions ATAU ip-config) -->
    @canany(['view-permissions', 'view-ip_config'])
      @php
